...
function onCreate()
    ...
    --setProperty('dadbattleLightEvent.scale.x', 1.9)
	setProperty('dadbattleLightEvent.scale.y', 0.7)
	setProperty('dadbattleLightEvent.antialiasing', true)
	setProperty('dadbattleLightEvent.alpha', 0.375)
	--setProperty('dadbattleLightEvent.angle', -30)
    ...
    --DAMN they broke getColorFromHex what the hell
